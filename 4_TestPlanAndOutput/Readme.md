...
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|      
| H_1 | Basic circuit solver. | - | - | - | Requirement based | 
| H_2 | Cable Capacities. | - | - | - | Requirement based | 
| H_3 | Circuit Calculator | - | - | - | Requirement based | 
| H_4 | Circular Convolution | - | - | - | Requirement based |
